...
public class WorldGenMineableSource extends WorldGenerator
{
    ...
    public WorldGenMineableSource(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.stone));
    }

    public WorldGenMineableSource(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
